...
class FileUploadHelper extends AppHelper{
  ...
  function __construct(){
    ...
    $this->options['width'] = 0; //0 means no resizing.
    $this->options['uploadDir'] = $this->FileUpload->uploadDir;
    /**
    * suggested 'resized', 
    * make sure webroot/files/resized is chmod 777
    */
    $this->options['resizedDir'] = '';  //suggested 'resized'
  }
  ...
  function _htmlImage(){
    ...
    if($this->resizeThumbOnly || !$options['width']) unset($options['width']); 
